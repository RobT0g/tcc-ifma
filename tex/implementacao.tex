...
pelo \texttt{Mecanismo de travamento} na Figura \ref{fig:abstracaosw}. Ela servirá apenas para indicar o estado atual de cada porta, facilitando a execução dos 
