...
% \begin{figure}[H]
% \centering
% \includegraphics[height=15cm]{figuras/feature\_model.png}
% \caption{Modelo \textbf{feature\_model.slx} que aplica o conceito de caixa preta.}
% \label{fig:featuremodel}
% \end{figure}

O modelo apresentado no Apêndice \ref{anex:anexo1} contém entradas auxiliares que ainda não estão contempladas no diagrama de caixa preta. Essas entradas foram adicionadas para tornar certos 
