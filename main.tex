...
\local{Santa Inês - MA}
\orientador{Prof. Dr. Aristoteles de Almeida Lacerda Neto}
\coorientador{Prof. Msc. Emanuel Cleyton Macedo Lemos}
...
\preambulo{Trabalho de Conclusão de Curso apresentado ao Instituto Federal do Maranhão, Campus Santa Inês, como requisito da obtenção do título de Bacharel em Engenharia de Computação.}
...
\begin{document}
	...
	\postextual
		...
		\begin{apendicesenv}
			%\partapendices
			\chapter{Modelo do sistema em caixa preta} \label{anex:anexo1}
